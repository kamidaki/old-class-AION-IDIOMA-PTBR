...
OUTPUT_BASE_DIR = r"F:\Servidor Aion\OLD CLASS SERVER\EDIT - CLIENT FILES\SOUNDS - EDIT\TRADUZIDOS - PASTAS ISOLADAS\npc"
        ...
        for fn in files:
            if fn.lower().endswith((".ogg", ".mp4")):
                ...
                try:
                    ...
                    time.sleep(2)  # Delay geral entre áudios para evitar sobrecarga!
